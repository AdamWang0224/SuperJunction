...
import cv2
from utils.utils_color import homography_scaling_torch as homography_scaling
from utils.utils_color import filter_points
...
class Coco(data.Dataset):
    ...
    def init_var(self):
        ...
        from utils.utils_color import inv_warp_image
        from utils.utils_color import compute_valid_mask
        from utils.photometric import ImgAugTransform, customizedTransform
        from utils.utils_color import inv_warp_image, inv_warp_image_batch, warp_points
